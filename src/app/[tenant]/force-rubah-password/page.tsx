...
export default function ForceChangePasswordPage() {
    ...
    useEffect(() => {
        if (!profile) {
            router.replace(toTenantPath("/login"));
        }
    }, [profile, router, toTenantPath]);
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h2 className="text-center text-2xl font-bold tracking-tight text-slate-900">
                    Otentikasi Keamanan SIMDATA Kecamatan
                </h2>
                <p className="mt-2 text-center text-sm text-slate-600">
                    User baru atau password berumur lebih dari 365 hari wajib rubah password. Demi keamanan sistem SIMDATA Kecamatan, Anda diwajibkan untuk memperbarui kata sandi sebelum melanjutkan.
                </p>
            </div>
