        ...
        <div className="min-h-screen bg-[#f8fafc] font-sans flex flex-col">
            ...
            <header className="relative overflow-hidden text-white bg-digital-batik">
                ...
                <div className="relative z-10 px-6 pt-8 pb-32 max-w-7xl mx-auto">
                    <Link href="/berita" className="inline-flex items-center gap-1 text-white/60 hover:text-white text-sm font-medium mb-6 transition-colors">
                            ...
                            <div className="flex flex-col gap-5">
                                {relatedNews.length > 0 ? (
                                    relatedNews.map((newsItem) => (
                                        <Link href={`/berita/${newsItem.slug}`} key={newsItem.id} className="group block">
